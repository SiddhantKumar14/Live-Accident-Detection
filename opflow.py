...
if __name__ == '__main__':
    vid_dir = '/home/siddhant/Codes/Accident Detection/221/'
    save_dir = '/home/siddhant/Codes/Accident Detection/opflow_save/'
    ...
    for ind, img_path in enumerate(images[:-1]):
        ...
        saveOptFlowToImage(flow, os.path.join(save_dir, basename), args.merge)
